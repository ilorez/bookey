function SearchBar() {
    ...
    `;
    return (
        <div key='serach-bar' className="flex justify-center mx-bookey-4 my-bookey-2">
            <div className="flex w-fit md:w-3/5 justify-between bg-bookey-red-200 px-bookey-2 py-bookey-1 rounded-lg">
                ...
                <button className="bg-bookey-red-800 rounded-md px-bookey-1-2 ">serach</button>
            </div>
        </div>
    )
}
